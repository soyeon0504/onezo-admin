...
<div align= "center"> 
    ...
    <div style="font-weight: 700; font-size: 15px; text-align: center; color: #c9d1d9;"> 원조치킨 관리자 페이지 </div> 
    <br/>
...
**🙋‍♀️ 사공은진**
  ...
  - 프로젝트 총 관리
  - 담당 페이지 : 로그인 페이지, 메인 페이지, 리뷰 관리 페이지, 매출 관리 페이지, 메뉴 품절 페이지

**🙋‍♀️ 박소연**

  - Git 관리
  - 담당 페이지 : 주문 관리 페이지, 주문 조회 페이지, 일정 관리 페이지, 공지 등록 페이지
